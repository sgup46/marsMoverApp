...
public class Plataeu {
	private static Plataeu instance;
	private int width = 5;
	private int breadth = 5;
	private Plataeu(){} // constructor is private to make sure no more table instances are created
	public static synchronized Plataeu getInstance()
	{
		if (instance == null)
		{
			instance = new Plataeu();
		}
		return instance;
